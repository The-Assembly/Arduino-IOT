...
char SSID[] = "ASSEMBLY";    //insert network name
char PASS[] = "WelcomeToASSEMBLY";    //insert network password

#define BOTtoken "865401148:AAFHTs6MnnbXWBdN_fNaSk7zM2nWLmOcZMU"    //insert your unique BOT token
#define LEDPIN 2
int pulse = 0 ;
